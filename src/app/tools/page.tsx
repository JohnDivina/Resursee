  ...
  const tools = [
    {
      ...
      icon: <ArrowsInLineHorizontal size={26} className="text-white dark:text-neutral-900" weight="bold" />,
    ...
    },
    {
      ...
      icon: <CornersOut size={26} className="text-white dark:text-neutral-900" weight="bold" />,
      iconBg: 'bg-neutral-900 text-white dark:bg-white dark:text-neutral-900',
    ...
    },
    {
      ...
      icon: <ArrowsClockwise size={26} className="text-white dark:text-neutral-900" weight="bold" />,
      iconBg: 'bg-neutral-900 text-white dark:bg-white dark:text-neutral-900',
    ...
    },
    {
      ...
      icon: <Crop size={26} className="text-white dark:text-neutral-900" weight="bold" />,
      iconBg: 'bg-neutral-900 text-white dark:bg-white dark:text-neutral-900',
    ...
    },
    {
      ...
      icon: <FileArrowDown size={26} className="text-white dark:text-neutral-900" weight="bold" />,
      iconBg: 'bg-neutral-900 text-white dark:bg-white dark:text-neutral-900',
    ...
    },
    {
      ...
      icon: <FileArrowUp size={26} className="text-white dark:text-neutral-900" weight="bold" />,
      iconBg: 'bg-neutral-900 text-white dark:bg-white dark:text-neutral-900',
