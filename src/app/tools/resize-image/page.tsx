          ...
          {!originalFile ? (
            <div className="mt-8">
              <FileUpload
                accept="image/*"
                maxSizeMB={50}
                title="Choose an image to resize"
                description="Scale photos for ID cards, portfolios, and custom dimension clearances."
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {PRESETS.map((preset) => (
                        <button
                          ...
                          className="rounded-[14px] border border-[var(--color-rule)] bg-[var(--color-paper-surface)] p-2.5 text-left hover:border-[var(--color-rule-strong)] hover:bg-[var(--color-paper-muted)] transition-colors"
                        >
