  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <BentoGrid className="max-w-7xl mx-auto auto-rows-auto lg:auto-rows-[19rem] grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {items.map((item, i) => (
            <BentoGridItem
              key={i}
              title={item.title}
...
// 4. Solid Neutral Graphic: Client-Side Media Toolbox
